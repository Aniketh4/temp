      ...
      <div class="article-container">
        <div class="article-ls">
          <div class="article-img">
            <?php
                $sql = "SELECT Lphoto, Num FROM News WHERE Type = 'Finance' AND Num IN (5)";
        ...
        <div class="article-rs">
          <div>
            ...
            <?php
                $sql = "SELECT Title, Num FROM News WHERE Type = 'Finance' AND Num IN (5)";
          ...
          <div class="article-data">
            <?php
            $sql = "SELECT Description, Num FROM News WHERE Type = 'Finance' AND Num IN (5)";
            // Prepare and execute the statement
            $stmt = $conn->prepare($sql);
            $stmt->execute();
